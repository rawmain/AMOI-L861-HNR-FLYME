...
.method public run()V
    ...
    iget v2, p0, Landroid/hardware/camera2/legacy/CameraDeviceUserShim$CameraLooper;->mCameraId:I

    invoke-virtual {v1, v2}, Landroid/hardware/Camera;->cameraInitUnspecified(I)I

    move-result v1

    iput v1, p0, Landroid/hardware/camera2/legacy/CameraDeviceUserShim$CameraLooper;->mInitErrors:I
    ...
    invoke-virtual {p0}, Landroid/hardware/camera2/legacy/CameraDeviceUserShim$CameraLooper;->close()V

    .line 140
    const-string/jumbo v1, "CameraDeviceUserShim"

    const-string/jumbo v2, "Hanging in CameraDeviceUserShim.java :137"
